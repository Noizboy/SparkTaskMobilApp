...
const invoiceHistory = [
  { id: 'INV-2025-11', date: '2025-11-01', amount: 29, status: 'paid', plan: 'Starter' },
  { id: 'INV-2025-10', date: '2025-10-01', amount: 29, status: 'paid', plan: 'Starter' },
  { id: 'INV-2025-09', date: '2025-09-01', amount: 29, status: 'paid', plan: 'Starter' },
  { id: 'INV-2025-08', date: '2025-08-01', amount: 29, status: 'paid', plan: 'Starter' },
];

export function BillingPage({ user }: { user: any }) {
